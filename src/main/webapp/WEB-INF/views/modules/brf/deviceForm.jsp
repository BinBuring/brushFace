...
<body>
	...
	<form:form id="inputForm" modelAttribute="device" action="${ctx}/brf/device/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="seq" htmlEscape="false" maxlength="255" class="input-xlarge required"/>
		...
		<div class="control-group">
			<label class="control-label">识别设备：</label>
			<div class="controls">
				<form:input path="aisle" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">设备版本号：</label>
			<div class="controls">
				<form:input path="ver" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
