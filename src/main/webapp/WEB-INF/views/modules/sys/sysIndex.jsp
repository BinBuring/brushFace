...
<div class="box">
    ...
    <div class="top">
        ...
        <div class="login fr">
            ...
            <a href="${ctx}/logout" title="退出登录"><p>退出</p></a>
        </div>
    </div>
    <!--中心-->
    <div class="container">
        ...
        <div class="sidebar fl">
            <div class="scroll">
                ...
                <div class="sidebar_item user_admin">
                ...
                <div class="sidebar_item platform_sett">
                ...
                <div class="sidebar_item big_data">
